    ...
    >
      ...
      <div>
        ...
        <ul className="list-disc pl-5 space-y-1">
          {details.requirements.map((req: string | number | bigint | boolean | ReactElement<any, string | JSXElementConstructor<any>> | Iterable<ReactNode> | ReactPortal | Promise<AwaitedReactNode> | null | undefined, index: Key | null | undefined) => (
            <li key={index}>{req}</li>
          ))}
        </ul>
      </div>
      <div>
        ...
        <ul className="list-disc pl-5 space-y-1">
          {details.responsibilities.map((resp: string | number | bigint | boolean | ReactElement<any, string | JSXElementConstructor<any>> | Iterable<ReactNode> | ReactPortal | Promise<AwaitedReactNode> | null | undefined, index: Key | null | undefined) => (
